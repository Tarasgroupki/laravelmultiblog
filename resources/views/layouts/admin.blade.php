                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('users_edit',['locale' => App::getLocale(),'user' => Auth::user()->id]) }}"
									>
									@lang('menu.profile')
									</a>
